...
from sqlalchemy import Column, Integer, String, Float, ForeignKey, Enum, Boolean,DateTime,Text
...
#     SupplierName=Column(String(50),nullable=False, unique=True)
#     author=Column(String(50),nullable=False, unique=True)
#     publishinghouse=Column(String(50),nullable=False, unique=True)
#     year=Column(Integer,nullable=False)
#     language=Column(String(50),nullable=False, unique=True)
#     weight=Column(Integer,nullable=False)
#     packagingsize=Column(String(50),nullable=False, unique=True)
#     numberofpages=Column(String(50),nullable=False, unique=True)
...
if __name__ == '__main__':
    with app.app_context():
        d1=ProductDetail(
            SupplierName='Kim Đồng',
            author='Yoshito Usui, Takata Mirei',
            publishing_house='Kim Đồng',
            year='2024',
            language='Tiếng Việt',
            weight='180',
            packaging_size='18 x 13 x 0.8 cm',
            number_of_pages='166',
            form='Bìa Mềm',
            product_id='2')
